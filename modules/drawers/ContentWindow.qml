...
StyledWindow {
    ...
    Interactions {
        ...
        BarWrapper {
            ...
            anchors.bottom: geometry.barOnTop ? undefined : parent.bottom
            anchors.left: geometry.horizontal ? parent.left : undefined
            anchors.right: geometry.horizontal ? parent.right : undefined
